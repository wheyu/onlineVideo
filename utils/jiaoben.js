...
$(function() {
    ...
    var css = [
        ...
        #why_home_btn {
            position: absolute; z-index: 9999; top: 100px; left:40px;
        }
...
`);
    ...
    $("#why_home_btn").click(function() {
        window.location.href = "https://wheyu.github.io/onlineVideo/"
    })
